...
const char * const BITCOIN_CONF_FILENAME = "mlcoin.conf";
const char * const BITCOIN_PID_FILENAME = "mlcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MLCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/MLCoin";
#else
    // Unix
    return pathRet / ".mlcoin";
#endif
#endif
}
